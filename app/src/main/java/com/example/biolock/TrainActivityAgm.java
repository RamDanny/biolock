...
public class TrainActivityAgm extends Activity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_train_agm);
    ...
    public void viewDb(View view) {
        Intent i = new Intent(TrainActivityAgm.this, ViewData.class);
